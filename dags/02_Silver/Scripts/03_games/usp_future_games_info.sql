/*
    ...
    Logic: Filters for unfinished games (finished = FALSE) and calculates season based on game_code ranges.
    Parameters: None
    Dependencies: bronze.games_info table must be populated prior to execution.
    Execution: Intended for daily scheduling via Airflow.
    Created: March 2025
*/
